...
try:
    ...
    tag = 'currentratio'  # str | An Intrinio data tag ID or code reference [see - https://data.intrinio.com/data-tags]
    ...
    end_date = '2020-01-01'  # date | Return historical data on or before this date (optional)
